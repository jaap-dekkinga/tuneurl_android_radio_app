...
package com.tuneurl.radio.core
...
data class Station(
    ...
    @Expose var imageURL: String = String(),
    ...
    @Expose var desc: String = String(),
    @Expose var longDesc: String= String(),

    @Expose var streamURL: String= String(),
) : Parcelable {
